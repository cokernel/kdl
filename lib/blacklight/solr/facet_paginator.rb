module Blacklight::Solr
  ...
  class FacetPaginator    
    ...
    @request_keys = {:sort => :'catalog_facet.sort', :offset => :'catalog_facet.offset', :limit => :'catalog_facet.limit', :prefix => 'catalog_facet.prefix'}
    class << self; attr_accessor :request_keys end # create a class method
    def request_keys ; self.class.request_keys ; end # shortcut
    
    attr_reader :total, :items, :offset, :limit, :sort, :prefix
